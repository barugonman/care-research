...
**Unit:** Co. A, 70th Engineer Battalion (Combat) ("Kodiaks"), 937th Engineer Group, 18th Engineer Brigade
**In-country service:** ~Aug 1965 – Oct 1969, Republic of Vietnam, II Corps Tactical Zone (An Khe → Pleiku → Ban Me Thuot)
...
## 1. The Standard You Are Asked to Apply

Under **38 U.S.C. § 5107(b)** and **38 C.F.R. § 3.102**, the VA must give the **benefit of the doubt** to the claimant when evidence is in approximate balance. The threshold for nexus opinions is therefore not "more likely than not" but ***"at least as likely as not"* (≥ 50% probability)**.

- **Use the verbatim phrase** *"at least as likely as not"* in each opinion.
- Avoid weak hedges that VA rejects: "possibly," "could be," "consistent with," "may be related to."
- The opinion is rendered to *reasonable medical certainty*, *not* to scientific certainty.
- For aggravation theories under 38 C.F.R. § 3.310(b), document the **baseline severity** of the non-service-connected condition prior to aggravation by the service-connected condition.

---

## 2. Service Exposure Profile

The 70th was the **first U.S. combat engineer battalion in Vietnam** — built Camp Radcliff at An Khe from raw jungle (4,300-ft runway, 275-acre helipad complex, 26 km defensive perimeter, 13,600+ POL drums, hospitals); Pleiku Province operations earned a **Presidential Unit Citation**; Ban Me Thuot operations included building 6 forward fire support bases. Routes 19/14/21 main supply route maintenance. Repeated mortar/sapper attacks (Camp Radcliff hit by 119 mortars in 5 minutes on 3 Sep 1966; ambushes documented by a 1968 Distinguished Service Cross to a 70th NCO).

| Exposure | Source in unit duties | Class / regulatory status |
|---|---|---|
| Tactical herbicides (Agent Orange / Purple / White, TCDD) | Aerial Ranch Hand defoliation of II Corps + ground-based perimeter spraying at base camps the unit built/maintained | **38 C.F.R. § 3.307(a)(6)(iii) presumes exposure** for any in-country RVN vet 1962–1975 |
| Trichloroethylene / chlorinated solvents | Daily motor-pool degreasing of diesel/gasoline engines | **IARC Group 1, sufficient evidence for kidney cancer** |
| JP-4 jet fuel, MOGAS, diesel, benzene | POL handling at Camp Radcliff/Pleiku/Ban Me Thuot; dust suppression; refueling | RCC case-referent OR ≈ 3.1–3.5; benzene leukemia/lymphoma |
| Burn pits / open-air waste burning | Excavated and ran burn pits at every base camp; trash + plastics + tires + feces in diesel | PM2.5 → HTN, IHD, stroke; kidney cancer presumptive *only* for post-1990 service eras, but [GAO-25-107504, May 2025](https://www.gao.gov/assets/gao-25-107504.pdf) formally documents Vietnam-era burn-pit reality |
| Crystalline silica | Operated rock quarries (drilling/blasting/crushing) for road base | Silicosis, silica-related CKD, autoimmune nephropathy |
| Asbestos | Heavy-equipment friction products; Transite roofing on tropical barracks | Mesothelioma, lung cancer |
| Lead | Leaded MOGAS, paints, solder, ordnance | HTN, CKD, cerebrovascular disease |
| Blast / concussive TBI | Demolitions, mine clearing, mortar/rocket/ambush exposure | Post-traumatic epilepsy with multi-decade latency (Vietnam Head Injury Study) |

**Bottom line:** Boots-on-ground presumption for herbicides is automatic. Beyond that, the unit's mission set produced one of the most extensive non-presumptive exposure profiles documented for any Vietnam cohort.
...
- NASEM *Update 2014* moved stroke to **"limited or suggestive evidence of association"** with herbicides ([NASEM, NCBI](https://www.ncbi.nlm.nih.gov/books/NBK195089/)). Illinois Vietnam veterans cohort: ischemic stroke OR 1.34 (95% CI 1.28–1.41) ([AHA Stroke 2024](https://www.ahajournals.org/doi/10.1161/str.55.suppl_1.WP249)).
- Latency: stroke at age 80+ in a Vietnam vet is the expected end-stage of 60 years of toxicant-driven endothelial injury and HTN.
- **Draft language:** *"It is at least as likely as not (probability ≥ 50%) that Mr. ___'s cerebrovascular accident was proximately caused by, and was proximately aggravated by, his service-connected hypertension and ischemic heart disease (38 C.F.R. § 3.310). Hypertension is the leading modifiable risk factor for stroke; the National Academies' Update 2014 finding of 'limited or suggestive evidence' of direct herbicide association supports an alternative direct theory."*

### Seizure — secondary to stroke (post-stroke epilepsy); alternative TBI theory
- **Post-stroke epilepsy accounts for 30–50% of new-onset seizures in patients ≥ 60.** Late seizures emerge predominantly 6–24 months post-stroke; substantial tail extends years later ([Neurology 2024](https://www.neurology.org/doi/10.1212/WNL.0000000000209450) · [PMC review](https://pmc.ncbi.nlm.nih.gov/articles/PMC9629926/)).
- Combat blast/concussive TBI is well-documented for Vietnam combat engineers; PTE latency is multi-decade ([Vietnam Head Injury Study, PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC3093742/)).
- Direct herbicide-seizure literature is weak/contested — rely on PSE/PTE secondary pathway.
- **Draft language:** *"Mr. ___'s seizure is at least as likely as not proximately caused by his cerebrovascular accident, which is itself service-connected secondary to service-connected hypertension and ischemic heart disease. Post-stroke epilepsy accounts for 30–50% of new-onset adult seizures and is the most common cause of late-life epilepsy. As an alternative theory, his combat-engineer exposure to demolitions and mortar/rocket attacks is consistent with mild traumatic brain injury, with post-traumatic epilepsy latency well-documented to extend decades after exposure."*

### Renal mass / suspected RCC — direct (Combee) **and** secondary to HTN
Not on the AO presumptive list (kidney cancer *is* on the burn-pit list but only for post-1990 eras). Direct claim under *Combee v. Brown*, 34 F.3d 1039 (Fed. Cir. 1994) is preserved.

Five converging carcinogenic pathways:

| # | Exposure | Evidence |
|---|---|---|
| 1 | **TCE** (motor-pool degreaser) | **IARC Group 1, sufficient evidence for kidney cancer in humans** ([IARC Mono 106](https://publications.iarc.who.int/_publications/media/download/3808/35dbe800bc961a10150e81ba239717d03dae477e.pdf); [NTP RoC](https://www.ncbi.nlm.nih.gov/books/NBK575906/)). S-DCVC metabolite directly damages proximal tubules and is mutagenic |
| 2 | **JP-4 / benzene** | RCC case-referent **OR 3.1 (90% CI 1.5–6.6) and 3.5 (95% CI 1.4–8.7)** ([VA Public Health — Jet fuels](https://www.publichealth.va.gov/exposures/petroleum/jet_fuels.asp)) |
| 3 | **TCDD / Agent Orange** | IARC Group 1; AhR → renal proximal-tubular oxidative stress; pooled meta-analysis of 31 dioxin cohorts (n = 29,605) showed significant kidney-cancer mortality elevation ([Xu et al., *Sci Rep* 2016](https://www.nature.com/articles/srep38012)) |
| 4 | **Hypertension** | Independently **doubles RCC risk** (OR ≈ 2.0); risk rises with HTN duration to **OR 2.6–4.1 after 25 years** ([Chow et al., NEJM 2000](https://www.nejm.org/doi/full/10.1056/NEJM200011023431804) · [Colt et al., PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC8109699/)) |
| 5 | **Crystalline silica** | Quarry operations → silica nephropathy (NLRP3 activation, autoimmune mechanisms) ([PMC review](https://pmc.ncbi.nlm.nih.gov/articles/PMC3266824/)) |
...
## 5. Unified Causal Chain

```
Service exposures (1965–69)              Pivotal physiology              Anchor presumptives          Downstream
────────────────────────────             ─────────────────────           ──────────────────         ─────────────
...
## 6. Letter Hard Requirements

- **Verbatim phrase: *"at least as likely as not"*** in each opinion.
- **Records reviewed** — name them (DD-214, civilian medical records, imaging, labs).
- **Mechanism + epidemiology + latency** — short paragraph per condition.
- **Cite peer-reviewed literature** (this document supplies citations to copy).
- **Aggravation cases** — document baseline severity per 38 C.F.R. § 3.310(b).
- **Specialist credentialing** carries the most weight; attach CV.
- **Sign with license #, board certification, contact info.**

---

## 7. Key References

**Statute / regulation:** [38 U.S.C. § 5107](https://www.law.cornell.edu/uscode/text/38/5107) · [38 C.F.R. § 3.102](https://www.ecfr.gov/current/title-38/chapter-I/part-3/subpart-A/subject-group-ECFR39056aee4e9ff13/section-3.102) · [§ 3.307](https://www.ecfr.gov/current/title-38/chapter-I/part-3/subpart-A/subject-group-ECFR39056aee4e9ff13/section-3.307) · [§ 3.309](https://www.ecfr.gov/current/title-38/chapter-I/part-3/subpart-A/subject-group-ECFR39056aee4e9ff13/section-3.309) · [§ 3.310](https://www.ecfr.gov/current/title-38/chapter-I/part-3/subpart-A/subject-group-ECFR39056aee4e9ff13/section-3.310) · *Combee v. Brown*, 34 F.3d 1039 (Fed. Cir. 1994) · *Allen v. Brown*, 7 Vet. App. 439 (1995)

**VA / federal:** [VA — Agent Orange](https://www.va.gov/disability/eligibility/hazardous-materials-exposure/agent-orange/) · [VA — PACT Act](https://www.va.gov/resources/the-pact-act-and-your-va-benefits/) · [VA Public Health — AO Conditions](https://www.publichealth.va.gov/exposures/agentorange/conditions/index.asp) · [GAO-25-107504, Vietnam Burn Pits (May 2025)](https://www.gao.gov/assets/gao-25-107504.pdf) · [89 FR 9938 — PACT Act final rule](https://www.federalregister.gov/documents/2024/02/12/2024-02590/updating-va-adjudication-regulations-for-disability-or-death-benefit-claims-related-to-exposure-to)

**NASEM / IARC:** [NASEM AO Update 2018 announcement](https://www.nationalacademies.org/news/vietnam-veterans-and-agent-orange-exposure-new-report) · [NASEM cardiovascular chapter](https://www.ncbi.nlm.nih.gov/books/NBK195089/) · [NASEM neurologic chapter](https://www.ncbi.nlm.nih.gov/books/NBK535896/) · [IARC Mono 106 — TCE (PDF)](https://publications.iarc.who.int/_publications/media/download/3808/35dbe800bc961a10150e81ba239717d03dae477e.pdf)
...
**Unit history:** [70th Engineer Bn — Army.mil](https://www.army.mil/article/166979/70th_engineer_battalion_history) · [70engrbtn.com](https://www.70engrbtn.com/) · [Camp Radcliff (Wikipedia)](https://en.wikipedia.org/wiki/Camp_Radcliff)
